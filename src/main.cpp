...
int pause = 1440;  // pause between transmissions, 22 = 1 second (approx)
...
char beaconstring[] = "CQ VA6WCT/FOX CQ VA6WCT/FOX"; // change to your call sign
char idstring[] = "DE VA6WCT"; // change to your call sign
int randNumber;
